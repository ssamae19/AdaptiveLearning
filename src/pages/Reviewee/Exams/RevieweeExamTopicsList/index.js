...
const RevieweeExamTopicsList = (({topicStore, currentLessonStore}) => {
    ...
    useEffect(() => {
        if(user.userType === "REVIEWEE") {
            currentLessonStore.getCurrentLessons(user.userID, id)
            setTimeout(() => {
...
export default inject('topicStore','currentLessonStore')(observer(RevieweeExamTopicsList))