...
const EditQuestion = (({questionBankStore}) => {
    ...
    useEffect(() => {
        if(questionBankStore.question) {
            form.setFieldsValue({
                ...questionBankStore.question,
                ...questionBankStore.question.options
            })
            setType(questionBankStore.question.type)
        }
    }, [questionBankStore.question])
    ...
    const onSubmit = (values) => {
        ...
        questionBankStore.updateQuestion(questionID, data)
    }
...
export default inject('questionBankStore')(observer(EditQuestion))